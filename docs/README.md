...
.venv-docs/bin/python tools/gen_schematic.py # docs/wiring/presync-schematic.svg
tools/gen_wiring.sh                          # docs/wiring/presync-harness.*
tools/gen_api_docs.sh                        # docs/api/
```

The last three need a virtual environment and graphviz:

```sh
brew install graphviz
python3 -m venv .venv-docs
.venv-docs/bin/pip install wireviz pdoc pyyaml numpy scipy pyxdf matplotlib
```
